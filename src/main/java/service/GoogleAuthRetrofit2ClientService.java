 ...
 */
public class GoogleAuthRetrofit2ClientService {
    private static final Logger log = LoggerFactory.getLogger(GoogleAuthRetrofit2ClientService.class);
    private StibeeRetrofit2Api stibeeRetrofit2Api;

    public GoogleAuthRetrofit2ClientService(String baseUrl) {
